...
# launch vllm server
model_name=model
CUDA_VISIBLE_DEVICES=0 vllm serve ${hf_model_path} --tensor-parallel-size 1 --gpu-memory-utilization 0.6  --chat-template-content-format string --served-model-name ${model_name} --trust-remote-code
